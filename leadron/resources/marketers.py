...
def create(config: Dict[str, Any], body: Dict[str, Any], **kwargs: Any) -> Any:
    res = http_module.request(config["api_key"], "POST", "/v1/marketers", body=body, **_opts_kw(config, **kwargs))
    return res["data"]


def get(config: Dict[str, Any], partner_id: str, **kwargs: Any) -> Any:
    res = http_module.request(config["api_key"], "GET", f"/v1/marketers/{partner_id}", **_opts_kw(config, **kwargs))
    return res["data"]


def update(config: Dict[str, Any], partner_id: str, body: Dict[str, Any], **kwargs: Any) -> Any:
    res = http_module.request(
        config["api_key"], "PUT", f"/v1/marketers/{partner_id}", body=body, **_opts_kw(config, **kwargs)
    )
    return res["data"]
...
def list_marketers(
    ...
    **kwargs: Any,
    ...
    res = http_module.request(
        config["api_key"], "GET", "/v1/marketers", query=query or None, **_opts_kw(config, **kwargs)
    )
    return res["data"]
...
def deactivate(config: Dict[str, Any], partner_id: str, **kwargs: Any) -> Any:
    res = http_module.request(
        config["api_key"], "POST", f"/v1/marketers/{partner_id}/deactivate", **_opts_kw(config, **kwargs)
    )
    return res["data"]
...
def get_referral_tree(config: Dict[str, Any], partner_id: str, **kwargs: Any) -> Any:
    res = http_module.request(
        config["api_key"], "GET", f"/v1/marketers/{partner_id}/hierarchy", **_opts_kw(config, **kwargs)
    )
    return res["data"]
...
def get_referral_link(config: Dict[str, Any], partner_id: str, **kwargs: Any) -> Any:
    res = http_module.request(
        config["api_key"], "GET", f"/v1/marketers/{partner_id}/referral-link", **_opts_kw(config, **kwargs)
    )
    return res["data"]
...
def get_stats(
    ...
    **kwargs: Any,
    ...
    res = http_module.request(
        config["api_key"], "GET", f"/v1/marketers/{partner_id}/metrics", query=query or None, **_opts_kw(config, **kwargs)
    )
    return res["data"]
...
def get_leaderboard(config: Dict[str, Any], opts: Optional[Dict[str, Any]] = None, **kwargs: Any) -> Any:
    query = {k: v for k, v in (opts or {}).items() if v is not None}
    res = http_module.request(
        config["api_key"], "GET", "/v1/marketers/leaderboard", query=query or None, **_opts_kw(config, **kwargs)
    )
    return res["data"]
...
def invite(config: Dict[str, Any], body: Dict[str, Any], **kwargs: Any) -> Any:
    res = http_module.request(config["api_key"], "POST", "/v1/marketers/invite", body=body, **_opts_kw(config, **kwargs))
    return res["data"]


def resend_invite(config: Dict[str, Any], partner_id: str, **kwargs: Any) -> Any:
    res = http_module.request(
        config["api_key"], "POST", f"/v1/marketers/{partner_id}/resend-invite", **_opts_kw(config, **kwargs)
    )
    return res["data"]
...
def get_onboarding_status(config: Dict[str, Any], partner_id: str, **kwargs: Any) -> Any:
    res = http_module.request(
        config["api_key"], "GET", f"/v1/marketers/{partner_id}/onboarding", **_opts_kw(config, **kwargs)
    )
    return res["data"]
...
def send_agreement(
    ...
    **kwargs: Any,
    ...
    res = http_module.request(
        config["api_key"],
        "POST",
        f"/v1/marketers/{partner_id}/agreements/send",
...
def get_signed_documents(config: Dict[str, Any], partner_id: str, **kwargs: Any) -> Any:
    res = http_module.request(
        config["api_key"], "GET", f"/v1/marketers/{partner_id}/documents/signed", **_opts_kw(config, **kwargs)
    )
    return res["data"]
...
def get_agreement_status(config: Dict[str, Any], partner_id: str, **kwargs: Any) -> Any:
    res = http_module.request(
        config["api_key"], "GET", f"/v1/marketers/{partner_id}/agreement-status", **_opts_kw(config, **kwargs)
    )
    return res["data"]
